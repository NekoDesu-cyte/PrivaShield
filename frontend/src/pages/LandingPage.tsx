  ...
  const processUploadedFile = async (file: File) => {
    ...
    if (!check.valid) {
      if (check.errorType === "INVALID_TYPE") {
        setAlert({
          ...
          title: "Upload Failed",
          message:
            "The image could not be uploaded. Please use a PNG, JPG, or WebP file under 10MB.",
        });
      } else {
        setAlert({
          isOpen: true,
          ...
          message:
            "Your image is too large to process. Please upload an image under 10MB.",
        });
      }
      return;
    }
    ...
    try {
      ...
      setAlert({
        ...
        message:
          "Gagal komunikasi dengan AI Server. Cek apakah backend sudah jalan.",
      });
      setIsScanning(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#F8F9FA] text-gray-900 font-sans flex flex-col">
          ...
          <main className="flex-grow flex flex-col items-center">
            <section className="flex flex-col items-center text-center px-4 pt-16 pb-12 w-full max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-600 mb-10 max-w-2xl">
                AI-powered detection for profile photos, phone numbers, and
                names. Redact sensitive information securely before sharing or
                storing.
              </p>
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 md:p-8">
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="h-64 rounded-lg overflow-hidden flex items-center justify-center relative border border-gray-200 bg-gray-100">
                      <img
                        src="/before.png"
                        alt="Original screenshot before censoring"
                  ...
                  <div className="flex flex-col">
                    ...
                    <div className="h-64 rounded-lg overflow-hidden flex items-center justify-center relative border border-gray-200 bg-gray-100">
                      <img
                        src="/after.png"
                        alt="Protected screenshot after censoring"
                        className="w-full h-full object-contain"
                      />

                      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 bg-white px-4 py-2 rounded-md shadow-lg flex items-center gap-2 font-semibold text-sm text-gray-800">
            ...
            <section className="w-full max-w-6xl px-4 py-20 text-center">
              ...
              <p className="text-gray-600 mb-12 max-w-2xl mx-auto">
                Our models are trained specifically to identify and isolate PII
                (Personally Identifiable Information) in complex UI screenshots.
              </p>
              <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 text-left">
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Automatically locates and blurs faces and avatars across
                    messaging apps, social feeds, and internal tools.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Identifies various international phone number formats inline
                    within text blocks or designated fields.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Context-aware NLP models highlight proper nouns that
                    indicate user names or handles.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm flex flex-col">
                  ...
                  <p className="text-sm text-gray-600 leading-relaxed">
                    Fine-tune the results with our intuitive brush tool for
                    custom redactions or adjustments.
                  </p>
                </div>
              </div>
            </section>
      ...
      {alert && (
        <AlertModal
          ...
          confirmLabel={
            alert.type === "error" ? "Try Again" : "Choose Another File"
          }
